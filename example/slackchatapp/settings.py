"""
Django settings for slackchatapp project.
...
SECRET_KEY = "&r3)+=1lal3%nzhm7q2e4ewnb68pse8@1$!d)5ft%$we-u%=m0"
...
ROOT_URLCONF = "slackchatapp.urls"
...
WSGI_APPLICATION = "slackchatapp.wsgi.application"
...
SLACKCHAT_MANAGERS = ["UUYL5LJ1X"]
SLACKCHAT_DEFAULT_OWNER = "UUYL5LJ1X"
SLACK_WEBHOOK_VERIFICATION_TOKEN = "%032x" % random.getrandbits(128)
SLACKCHAT_SLACK_LOGGER = "slack"
